...
- `background.js` is the service worker orchestrator: it manages API calls, CDP attachment, AX tree capture, plan execution, navigation resume, and interpreter-only plan generation used by E2E parity tests.
